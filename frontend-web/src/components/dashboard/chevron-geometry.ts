...
// Порт frontend-app/src/chevron-geometry.ts — та же формула, тот же дашборд
// «Путь», просто здесь его рисует не встроенный в HTML-отчёт бандл, а
// отдельное Next.js-приложение (frontend-web/).
//
//   ss = min(w, h)
//   maxAdj = 100000 * w / ss
