...
// не выдумано, вытащено из XML презентации. Порт frontend-app/src/Chevron.tsx.
...
export function Chevron({
  title, color, pct, index = 0, width = 220, height = 90, selected = false,
}: ChevronProps) {
  const clipId = useId();
  ...
  return (
    <svg
      className={`journey-chevron${selected ? " journey-chevron-selected" : ""}`}
